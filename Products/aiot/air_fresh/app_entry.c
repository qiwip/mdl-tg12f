...
int application_start(int argc, char **argv)
{
...
#ifdef MANUFACT_AP_FIND_ENABLE
    netmgr_manuap_info_set("Qi", "66668888", manufact_ap_find_process);
#endif
    ...
    aos_task_new_ext(&task_property_report, "property detect", process_detect_property_change, NULL, 3072 + 1024, AOS_DEFAULT_APP_PRI);
#else
    aos_task_new_ext(&task_property_report, "property report", process_property_report_task, NULL, 2048, AOS_DEFAULT_APP_PRI);
    aos_task_new_ext(&task_property_report, "property detect", process_detect_property_change, NULL, 3072, AOS_DEFAULT_APP_PRI);
